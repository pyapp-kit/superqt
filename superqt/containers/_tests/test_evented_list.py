...
from superqt.containers import EventedList
...
@pytest.mark.parametrize(
    ...
    [
        ...
        # primary interface
        ('insert', (2, 10), ('insertingItem', 'itemInserted')),  # create
        ('__getitem__', (2,), ()),  # read
        ('__setitem__', (2, 3), ('itemChanged',)),  # update
        ('__setitem__', (slice(2), [1, 2]), ('itemChanged',)),  # update slice
        ('__setitem__', (slice(2, 2), [1, 2]), ('itemChanged',)),  # update slice
        ('__delitem__', (2,), ('removingItem', 'itemRemoved')),  # delete
        (
            '__delitem__',
            (slice(2),),
        ...
        # inherited interface
        ('append', (3,), ('insertingItem', 'itemInserted')),
        ('clear', (), ('removingItem', 'itemRemoved') * 5),
        ('count', (3,), ()),
        ('extend', ([7, 8, 9],), ('insertingItem', 'itemInserted') * 3),
        ('index', (3,), ()),
        ('pop', (-2,), ('removingItem', 'itemRemoved')),
        ('remove', (3,), ('removingItem', 'itemRemoved')),
        ('reverse', (), ('reordered',)),
        ('__add__', ([7, 8, 9],), ()),
...
def test_list_interface_parity(test_list, regular_list, meth):
    ...
    # test methods produce same results
...
def test_move(test_list):
    ...
    test_list.removingItem.connect(_fail)
    test_list.itemRemoved.connect(_fail)
    test_list.insertingItem.connect(_fail)
    test_list.itemInserted.connect(_fail)
