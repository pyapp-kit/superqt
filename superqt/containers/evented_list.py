...
from .typed import _L, _T, Index, TypedMutableSequence
...
class EventedList(TypedMutableSequence[_T]):
    ...
    # def _reemit_child_event(self, event):
    ...
    #     getattr(self.events, event.type, self.events)(event) # TODO: look at this
    #
    ...
    #         child.events.disconnect(self._reemit_child_event) # TODO: look at this
    #
    ...
    #         child.events.connect(self._reemit_child_event) # TODO: look at this
