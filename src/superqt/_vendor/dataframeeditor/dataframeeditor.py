# code adapted from Spyder's code: spyder/plugins/variableexplorer/widgets/basedialog.py
# https://github.com/spyder-ide/spyder/blob/master/spyder/plugins/variableexplorer/widgets/dataframeeditor.py
...
class DataFrameEditor(BaseDialog):
    ...
    def setup_and_check(self, data, title: str = ""):
        """
        ...
        self.btn_save_and_close = QPushButton(trans_("Save and Close"))
        self.btn_save_and_close.setDisabled(True)
        self.btn_save_and_close.clicked.connect(self.accept)
        btn_layout.addWidget(self.btn_save_and_close)

        self.btn_close = QPushButton(trans_("Close"))
    ...
    def change_format(self):
        ...
        if valid:
            ...
            try:
                ...
                msg = trans_("Format ({}) is incorrect").format(format)
                QMessageBox.critical(self, trans_("Error"), msg)
                return
            if not format.startswith("%"):
                msg = trans_("Format ({}) should start with '%'").format(format)
                QMessageBox.critical(self, trans_("Error"), msg)
                return
...
class DataFrameModel(QAbstractTableModel):
    ...
    def get_value(self, row, column):
        ...
        except pd._libs.tslib.OutOfBoundsDatetime:  # noqa E722:
...
class DataFrameLevelModel(QAbstractTableModel):
    ...
    def headerData(self, section, orientation, role):
        ...
        if self.model.header_shape[0] <= 1 and orientation == Qt.Horizontal:
            ...
            return None
        return trans_("Index") + " " + str(section)
